...
# Sun May 15 17:43:32 PDT 2022
# DO NOT MODIFY


# 
# avalon_sram_controller "Avalon MM Sram Controller" v1.0
# Heqing Huang 2022.05.15.17:43:32
# 
# 
...
add_parameter AVN_AW INTEGER 19
...
add_parameter AVN_DW INTEGER 16
...
add_interface_port avs avn_read read Input 1
add_interface_port avs avn_write write Input 1
add_interface_port avs avn_address address Input AVN_AW
add_interface_port avs avn_writedata writedata Input AVN_DW
add_interface_port avs avn_readdata readdata Output AVN_DW
add_interface_port avs avn_byteenable byteenable Input AVN_DW/8
...
add_interface_port sram sram_dq export Bidir SRAM_DW
